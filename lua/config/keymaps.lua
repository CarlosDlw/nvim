...
map("n", "<leader>oc", "<cmd>AsmConstants<cr>", { desc = "Asm constants" })
map("n", "<leader>oa", "<cmd>AsmAscii<cr>", { desc = "Asm ASCII table" })
map("n", "<leader>oh", "<cmd>AsmHex<cr>", { desc = "Asm hex values" })
map("n", "<leader>oo", "<cmd>AsmOctal<cr>", { desc = "Asm octal values" })
map("n", "<leader>ob", "<cmd>AsmBinary<cr>", { desc = "Asm binary values" })
map("n", "<leader>od", "<cmd>AsmDirectives<cr>", { desc = "Asm directives" })
map("n", "<leader>or", "<cmd>AsmRegisters<cr>", { desc = "x86_64 registers" })
map("n", "<leader>oi", "<cmd>AsmInstructions<cr>", { desc = "x86_64 instructions" })
map("n", "<leader>os", "<cmd>AsmSyscalls<cr>", { desc = "x86_64 syscalls" })
map("n", "<leader>oe", "<cmd>AsmDo<cr>", { desc = "Asm conversion helper" })
